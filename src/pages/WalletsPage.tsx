          ...
          <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <article className="relative card overflow-hidden p-6">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <a
                  className="btn btn-primary"
                  href="https://github.com/signum-network/signum-node/releases/download/v3.9.11/signum-node-v3.9.11-win_x64.zip"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="Download for Windows"
                  title="Download for Windows"
                ...
                <a
                  className="btn btn-ghost"
                  href="https://github.com/signum-network/signum-node/releases/download/v3.9.11/signum-node-v3.9.11.zip"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="Download for Linux"
                  title="Download for Linux"
